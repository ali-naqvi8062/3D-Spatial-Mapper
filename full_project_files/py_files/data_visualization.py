...
f = open("tofff_radar.xyz", "w")    #create a new file for writing
...
for x in range(0,6600,300): #30cm step measurement (i.e for each 32 scan I move the sensor up 30cm in the hallway)
